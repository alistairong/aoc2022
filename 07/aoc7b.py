...
def getCurrUnusedSpace(dirSizes: dict[int, int]) -> int:
    return 70000000 - dirSizes[0]

def getDirToDelete(dirSizes, spaceLeft, spaceNeeded):
    minSize = spaceNeeded - spaceLeft
...
print(getDirToDelete(dirSizes, getCurrUnusedSpace(dirSizes), 30000000))